...
export const AchievementUnlocks = Object.freeze([
    ...
    "Collect every non-DLC item, and unlock every secret and ending (minus The Lost)",
    ...
    "Defeat Mom's Heart 10 times",
    "Unlock as many achievements as there were in Afterbirth",
    ...
    "Unlock all achievements and collect every item",
    "Play an online run",
    "Win an online run",
    "Win an online Daily Run",
    "Defeat Mom",
]);
