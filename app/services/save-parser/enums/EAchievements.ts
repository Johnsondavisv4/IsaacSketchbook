...
export const AchievementUnlocks = Object.freeze([
    ...
    "Unlock all other 636 achievements and collect every single item in the game",
    "Play an online co-op run in Repentance+ Online",
    "Win an online co-op run in Repentance+ Online",
    "Win an Online Daily Challenge run in Repentance+ Online",
    "Defeat Mom",
]);
